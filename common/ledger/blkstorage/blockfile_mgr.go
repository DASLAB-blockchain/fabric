...
func (mgr *blockfileMgr) addBlock(block *common.Block) error {
	...
	logger.Warnf("block %d elapsedAppendFile (%d bytes) time: %v\n",
               block.Header.Number,
			   len(blockBytes),
               elapsedAppendFile)
	...
	logger.Warnf("block %d elapsedSaveBlkInfo time: %v\n",
               block.Header.Number,
               elapsedSaveBlkInfo)
	...
	logger.Warnf("block %d elapsedSaveIndex time: %v\n",
               block.Header.Number,
               elapsedSaveIndex)
	...
	logger.Warnf("block %d elapsedUpdateBFInfo time: %v\n",
               block.Header.Number,
               elapsedUpdateBFInfo)
	...
	logger.Warnf("block %d elapsedUpdateBCInfo time: %v\n",
               block.Header.Number,
               elapsedUpdateBCInfo)
	return nil
}
